...
screen.title("Dasara Mandala with Center Text")
t = turtle.Turtle()
t.speed(0)
t.hideturtle()
...
def draw_lotus_layer(t, radius, petals):
    ...
    for i in range(petals):
        t.color(random.choice(mandala_colors))
        t.penup()
        t.goto(0,0)
...
for layer in range(1,6):
    ...
    turtle.update()  # Update drawing layer by layer

# Pause for 30 seconds (mandala “appears” instantly)
time.sleep(1)  # Optional: short pause if needed

# Write "Happy Dasara" after mandala
t.penup()
t.goto(0, -20)
t.pendown()
t.color("cyan")
t.write("🎉 Happy Dasara 🎉", align="center", font=("Arial", 36, "bold"))
